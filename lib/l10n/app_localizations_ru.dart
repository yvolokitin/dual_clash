...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get adminModeEnableTitle => 'Включить режим администратора';

  @override
  String get adminModeEnableMessage =>
      'Включить режим администратора на этом устройстве?\n\nПоявятся пункты симуляции.';
  ...
  String get webSaveGameNote =>
      'Веб‑примечание: ваше сохранение будет храниться в локальном хранилище этого браузера для этого сайта. Оно не синхронизируется между устройствами и не сохраняется в приватных окнах.';

  @override
  String get webLoadGameNote =>
      'Веб‑примечание: список ниже берётся из локального хранилища этого браузера для этого сайта (не используется совместно с другими браузерами и приватными окнами).';
}
